...
<body>
    <div class="container">
      ...
      <div class="card-header"><h4>List Project</h4></div>
        <br />
...
$(document).ready(function() {
  $('#table tbody').on('click', 'td.details-control', function () {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('crud_project/ajax_list')?>",
            "type": "POST"
        },
...
<!-- Modal Hapus Produk-->
<!-- Logout Modal-->
<form id="add-row-form" action="<?php echo base_url().'crud_project/hapus'?>" method="post">
