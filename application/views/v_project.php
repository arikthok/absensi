...
<body>
	    ...
	    <div class="container " >
	      <div class="card mt-3">
            ...
            <div id="info"></div>
	         ...
	         <?php echo form_open('crud_project/data', 'id="mydata" '); ?>
	         ...
	         <div class="form-group ">
	              ...
	              <div class="form-row ">
	                ...
	                <div class="col-md-5">
	                  <div >
	                    <input type="text" tabindex="1" id="name" name="name" class="form-control" autocomplete="off" required="required" data-error="Please enter your full name.">
	              ...
	              <div class="form-row ">
	                ...
	                <div class="col-md-4">
	                  <div >
	                    <input type="text" tabindex="7" id="value" name="value" class="form-control"   autocomplete="off" required="required">
	                  </div>
	                </div>
	              </div>
	            </div>
				 ...
				 <div class="form-row ">
					 <div class="col">
						 <div class="form-row ">
							 <div class="col-md-4">
								 <div >
									<label for="firstName">Project Code</label>
								 </div>
							 </div>
							 <div class="col-md-5">
							<div class="input-group" id="code">
									 <input type="text" max="999999" tabindex="2"  name="code" autocomplete="off" class="form-control"  required="required">
                   <input type="text" name="code2" autocomplete="off" class="form-control col-sm-3 "
                   value="00" required="required" style="padding-left:17px">
 								</div>
							 </div>
						 </div>
					 </div>
				 ...
				 <div class="col">
					 <div class="form-group ">
						 <div class="form-row ">
							 ...
							 <div class="col-md-4">
								 <div >
									 <input name="pic" tabindex="8" id="pic" class="form-control" autocomplete="off" placeholder="Type Name User" >
								 </div>
							 </div>
						 </div>
					 </div>
         ...
         <div class="form-row ">
           ...
           <div class="col-md-5">
             <div class="form-check">
   						 <input type="radio" tabindex="3" class="form-check-input" id="type" name="type" value="ar" required="required">
   						 <label class="form-check-label" for="type">Architecture</label>
   						 </div>
   						 <div class="form-check">
   						 <input type="radio" tabindex="4"  class="form-check-input" id="type" name="type" value="mp" required="required">
   						 <label class="form-check-label" for="type">Master Planning</label>
   						 </div>
							 <div class="form-check">
   						 <input type="radio" tabindex="5"  class="form-check-input" id="type" name="type" value="mp/ar" required="required">
         ...
         <div class="form-row ">
           ...
           <div class="col-md-4">
             <div ><div class="input-group">
               <input id="datepicker" tabindex="10" autocomplete="off" name="start"  class="form-control" required="required" />
		  ...
		  <div class="form-row ">
		 	 <div class="col">
		 		 <div class="form-row ">
					 ...
					 <div class="col-md-5">
             <input name="location" tabindex="5" id="location" class="form-control" >
		  ...
		  <div class="col">
		 	 <div class="form-group ">
		 		 <div class="form-row ">
					 ...
					 <div class="col-md-4">
             <div ><div class="input-group">
               <input id="datepicker2" tabindex="10" autocomplete="off" name="end"  class="form-control" required="required" />
               <button type="button" class="btn btn-outline-secondary" disabled>
               <span class="far fa-calendar-alt"></span>
             </button>
              </div>
  ...
  $( "#datepicker2" ).datepicker({dateFormat: 'yy-mm-dd'});
		 ...
		 <div class="form-group ">
			 <div class="form-row ">
                ...
                <input type="text" name="client_name" class="form-control" id="title" required="required"  placeholder="Type Name Client" >
 ...
 <input class="submit center-block btn btn-primary" tabindex="11" value="Register" type="submit">

				</div>
	          </form>
	          <div class="text-center">

	            <a class="d-block small mt-3" href="<?php echo base_url();?>crud_project/list_project" tabindex="12">List Project</a>
...
$(document).ready(function(){
        ...
        $('#value').autoNumeric('init', {aSep: '.', aDec: ',', vMin: '0', vMax: '99999999999' });
    });
	              ...
	              <div class="col">
	                <div class="form-group ">
	                  <div class="form-row ">
	                    ...
	                    <div class="col-md-6">
	                      <div >
	                        <input type="text" tabindex="6" id="email" name="email" class="form-control" autocomplete="off" >
	                      </div>
	                    </div>
	                  </div>
	                </div>
