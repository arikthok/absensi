...
<body>
  ...
  <div class="col-md-4" style="padding-left: 0px;">
    <div class="container " >
      <div class="card mt-3">
        <div class="card-header"><h4>Edit Rate</h4></div>
        <div class="card-body">
          <div id="info"></div>

<?php foreach($rate as $u){ ?>
         <?php echo form_open('crud_rate/update', 'id="mydata" '); ?>
          ...
          <div class="form-row ">
            <div class="col">
              <div class="form-row ">
                ...
                <div class="col-md-7">
                  <div >
                    <input value="<?php echo $u->id_rate ?>" type="hidden" tabindex="1" id="id_rate" name="id_rate" class="form-control" autocomplete="off" required="required" data-error="Please enter your kode proyek">

                    <input value="<?php echo $u->position ?>" type="text" tabindex="1" id="position" name="position" class="form-control" autocomplete="off" required="required" data-error="Please enter your kode proyek">
       ...
       <div class="form-row ">
         <div class="col">
           <div class="form-row ">
             ...
             <div class="col-md-7">
               <div >
                 <input value="<?php echo $u->rate ?>"type="text" tabindex="2" id="rate" name="rate" autocomplete="off" class="form-control"  required="required">
               </div>
             </div>
           </div>
         </div>
    ...
    <input class="submit center-block btn btn-primary" tabindex="9" value="Update Rate" type="submit">
      </div>
          </form>
<?php } ?>
          </div>
